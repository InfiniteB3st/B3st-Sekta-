            ...
            >
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div className="space-y-2">
                  <h2 className="text-6xl font-black italic text-white uppercase tracking-tighter">System Configuration</h2>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {STATUSES.map(s => (
                      <button 
                        ...
                        className={cn("px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest border transition-all", status === s.value ? 'bg-primary border-primary text-black' : 'bg-white/3 border-white/5 text-gray-600 hover:border-white/20')}
                      >
                        {s.name}
                      </button>
                    ))}
